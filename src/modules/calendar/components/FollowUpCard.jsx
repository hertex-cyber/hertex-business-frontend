  ...
  return (
    <div className="p-3 bg-white/[0.06] border border-white/10 rounded-xl space-y-1.5 cursor-pointer hover:bg-white/[0.08] transition-all" onClick={onClick}>
      <div className="flex items-start justify-between gap-2">
        ...
        <span className="shrink-0 px-1.5 py-0.5 rounded-full border text-[8px] font-bold uppercase tracking-wider text-pink-400 bg-pink-500/10 border-pink-500/20">Follow Up</span>
      </div>
